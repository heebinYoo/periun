...
class TinyImageNetDataset(Dataset):
    def __init__(self, image_folder_set, norm_trans=None, start=0, end=-1, cache_file=None):
        self.transform = image_folder_set.transform
        ...
        if cache_file is not None and os.path.exists(cache_file):
            ...
            print("Processing images and saving cache...")
            self.imgs = []
            self.targets = []
            ...
            if cache_file is not None:
                torch.save({'imgs': self.imgs, 'targets': self.targets}, cache_file)
